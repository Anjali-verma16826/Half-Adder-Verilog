...
REM
REM Generated by Vivado on Sat Feb 21 15:17:50 +0530 2026
...
echo "xvlog --incr --relax -prj tb_HF_vlog.prj"
call xvlog  --incr --relax -prj tb_HF_vlog.prj -log xvlog.log
